...
public class DepthData {
    ...
    private static final String TAG = DepthData.class.getSimpleName();
...
//        Log.e(TAG, "W: "+String.valueOf(depthWidth));
//        Log.e(TAG,"H: "+String.valueOf(depthHeight));

        for (int y = depthHeight/4; y < depthHeight-depthHeight/4; y += step) {
            for (int x = depthWidth/8; x < depthWidth-depthWidth/8; x += step) {
                ...
                if (confidenceNormalized >= 0.00 && (depthMeters > 1.6 && depthMeters < 2.0)) {
...
//                    if(x < depthWidth/8 || x > depthWidth-depthWidth/8){
//                        continue;
//                    }
//                    if(y < depthHeight/4 || y > depthHeight-depthHeight/4){
//                        continue;
//                    }
...
//                points.put(confidenceNormalized);
    ...
    public static void filterUsingPlanes(FloatBuffer points, Collection<Plane> allPlanes, float filtervalue) {
        ...
        for (Plane plane : allPlanes) {
            ...
            for (int index = 0; index < numPoints; ++index) {
                ...
                if (Math.abs(distance) > filtervalue) {
